<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-label="Notifications" role="img">
    <path d="M12 6.44043V9.77043" stroke="#2E293B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" />
    <path
