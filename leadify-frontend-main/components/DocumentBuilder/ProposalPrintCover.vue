...
<img v-else src="/images/Logo.png" class="h-10 w-auto brightness-0 invert opacity-80 object-contain" alt="Logo" />
                        ...
                        <div class="w-2/3 bg-white p-20 flex flex-col justify-center relative">
                            ...
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <span class="text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-sm" :class="`bg-${typeInfo.color}-100 text-${typeInfo.color}-800`">{{ typeInfo.fullLabel }}</span>
                            </div>
...
<img v-else src="/images/Logo.png" class="h-12 w-auto object-contain" alt="Logo" />
                        ...
                        <div class="flex-1">
                            ...
                            <div class="inline-block mb-12 px-3 py-1 text-xs font-bold uppercase tracking-wider border" :class="`bg-${typeInfo.color}-100 text-${typeInfo.color}-800 border-${typeInfo.color}-200`">{{ typeInfo.fullLabel }}</div>
...
<div v-else class="font-bold text-2xl tracking-tighter shadow-cyan-400/50">HP.NEON</div>
                            <div class="flex items-center gap-6">
                                <img v-if="data.clientLogo" :src="data.clientLogo" class="h-10 w-auto brightness-0 invert opacity-40 shadow-[0_0_10px_rgba(255,255,255,0.1)]" alt="Client Logo" />
                    ...
                    <div class="flex-1 flex flex-col bg-yellow-300 p-12 relative overflow-hidden h-full"><!-- Background Pattern --><div class="absolute inset-0 opacity-10" :style="{  backgroundImage: 'radial-gradient(circle, #000 2px, transparent 2.5px)', backgroundSize: '20px 20px'  }"></div><!-- Shapes --><div class="absolute top-20 right-[-50px] w-64 h-64 bg-pink-500 rounded-full border-4 border-black"></div>
                        ...
                        <div class="relative z-10 flex flex-col items-center mt-12 w-full">
                            <div class="flex justify-between items-start w-full mb-12 px-8">
                                <img v-if="data.logo" :src="data.logo" class="h-10 w-auto contrast-150 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white border-2 border-black p-1" alt="Logo" />
<div v-else class="font-bold text-2xl tracking-tighter border-2 border-black p-1 bg-white">HP.</div>
                                <img v-if="data.clientLogo" :src="data.clientLogo" class="h-10 w-auto contrast-125 grayscale shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white border-2 border-black p-1" alt="Client Logo" />
                            </div>
    ...
    <!-- Style: futuristic-grid -->
                ...
                <ProposalPrintPage :isCover="true" :data="data" v-if="data.coverStyle === 'futuristic-grid'">
                    <div class="flex-1 flex flex-col bg-slate-900 text-cyan-400 p-12 relative font-mono h-full"><!-- Grid --><div class="absolute inset-0 opacity-20"
                            :style="{ backgroundImage: 'linear-gradient(' + color + '80 1px, transparent 1px), linear-gradient(90deg, ' + color + '80 1px, transparent 1px)',
...
<div v-else class="text-2xl font-serif italic text-[#5e503f]/40">High Point</div>
                                <img v-if="data.clientLogo" :src="data.clientLogo" class="h-16 w-auto opacity-30 sepia brightness-90 grayscale contrast-125" alt="Client Logo" />
                            </div>
