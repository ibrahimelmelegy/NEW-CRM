<template>
  <div class="pro-doc-builder h-full flex flex-col bg-slate-50 overflow-hidden font-sans">
    <!-- Top Navigation Bar -->
    <header
      class="h-16 flex items-center justify-between px-6 shrink-0 z-20 m-4 rounded-[2rem]"
      style="
    ...
    >
      <div class="flex items-center gap-4">
        <div
          ...
          style="background: rgba(124, 58, 237, 0.1); color: var(--el-color-primary)"
        >
          <FileText size="20" />
        </div>
        <div>
    ...
    <main class="flex-1 flex overflow-hidden">
          ...
          <div v-if="activeStep === 'branding'" class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
              <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <FileText size="20" class="text-violet-500" />
                Document Details
              </h3>
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
              <div class="flex items-center justify-between mb-6">
                <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <User size="20" class="text-violet-500" />
                  Client Information
                </h3>
                <el-select
              ...
              <div v-if="!isFullDoc" class="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    v-model="formData.clientTaxId"
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-violet-500 focus:ring-2 focus:ring-violet-200 outline-none transition-all text-sm font-bold text-gray-800"
                    placeholder="3XXXXXXXXXXX03"
                  />
                </div>
              </div>
            </div>
            ...
            <div v-if="!isFullDoc" class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
              <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <FileText size="20" class="text-emerald-500" />
            ...
            <div
              v-if="['invoice', 'proforma_invoice', 'credit_note'].includes(props.documentType)"
              class="bg-white p-8 rounded-[2rem] shadow-sm border border-blue-100"
            >
              <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <DollarSign size="20" class="text-blue-500" />
              ...
              <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-violet-500 focus:ring-2 focus:ring-violet-200 outline-none transition-all text-sm font-bold text-gray-800 font-mono"
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100">
              <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <Palette size="20" class="text-violet-500" />
                Design & Theme
              </h3>
              ...
              <div v-else class="bg-violet-50 border border-violet-100 rounded-xl p-4">
                <p class="text-sm text-violet-700 flex items-center gap-2">
                  ...
                  This document type uses a pre-designed professional template. The theme color above will be applied automatically.
                </p>
              </div>
            </div>
          </div>
          ...
          <div v-else-if="activeStep === 'financial'" class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 mb-8">
              <div class="flex items-center justify-between mb-8">
                <h3 class="text-xl font-bold text-gray-900 flex items-center gap-2">
                  <DollarSign size="20" class="text-violet-500" />
                  Pricing & Investment
                </h3>
                ...
                <table class="w-full text-left border-collapse">
                  <thead>
                    <tr class="border-b-2 border-gray-100">
                      ...
                      <th class="pb-4 text-right text-xs font-bold text-gray-400 uppercase tracking-widest w-[15%]">
                ...
                <div class="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <div class="flex gap-2">
                      ...
                      <select
                        ...
                        class="w-24 px-2 py-2 bg-gray-50 border border-gray-200 rounded-xl outline-none text-sm font-bold"
                      >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      class="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl outline-none text-sm font-bold"
                    >
      ...
      >
        ...
        <div :style="{ transform: `scale(${zoom})`, transformOrigin: 'top center' }" class="transition-transform duration-200 pb-[100px]">
          ...
          <ProposalPrintTemplate v-if="isFullDoc" :data="formData" />
          <!-- All other docs: Fixed professional template -->
          <FixedDocumentTemplate v-else :data="formData" />
        </div>
      </section>
    </main>
  </div>
...
const formData = reactive<ProposalData>({
  ...
  customSections: [],
  currency: 'SAR',
  items: [{ id: 1, description: 'Discovery & Planning', quantity: 1, unit: 'Lump Sum', cost: 0, margin: 20, rate: 5000 }],
  taxRate: 15,
  discount: 0,
