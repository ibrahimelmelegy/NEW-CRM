...
const componentPath = resolve(__dirname, '../../../../components/client/Form.vue');
let content: string;
...
describe('Client Form - Design System Compliance', () => {
  describe('Structure', () => {
  ...
  describe('Form Inputs', () => {
    ...
    it('should contain el-switch for lead/client toggle', () => {
      expect(content).toContain('el-switch');
    });

    it('should contain InputUploadFiles for file upload', () => {
      expect(content).toContain('InputUploadFiles');
    });
  });
  ...
  describe('i18n Integration', () => {
    ...
    it('should reference clients translation keys', () => {
      expect(content).toContain("$t('clients.");
    });
  });
