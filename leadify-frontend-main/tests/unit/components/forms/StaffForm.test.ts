...
const componentPath = resolve(__dirname, '../../../../components/Staff/Form.vue');
let content: string;
...
describe('Staff Form - Design System Compliance', () => {
  describe('Structure', () => {
  ...
  describe('Form Sections', () => {
    ...
    it('should have Profile Picture section', () => {
  ...
  describe('Form Inputs', () => {
    ...
    it('should contain InputSelect fields for role and status', () => {
    ...
    it('should contain InputUploadImage for profile picture', () => {
      expect(content).toContain('InputUploadImage');
    });
  ...
  describe('i18n Integration', () => {
    ...
    it('should reference staff translation keys', () => {
      expect(content).toContain("$t('staff.");
    });
  });
  ...
  describe('Theme Compliance', () => {
    ...
    it('should use CSS variable for text color', () => {
