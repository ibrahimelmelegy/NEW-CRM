...
div
  ...
  .glass-card.p-6.rounded-2xl.mb-6
    .flex.items-center.justify-between.mb-4
      ...
      el-select(v-model="distributionPeriod" size="small" style="width: 160px" @change="loadDistribution")
        ...
        el-option(:label="$t('performance.q3_2026')" value="Q3-2026")
        el-option(:label="$t('performance.q4_2026')" value="Q4-2026")
        el-option(:label="$t('performance.annual_2025')" value="ANNUAL-2025")
        el-option(:label="$t('performance.annual_2026')" value="ANNUAL-2026")
  ...
  .flex.items-center.gap-3.mb-4
    ...
    el-select(v-model="statusFilter" :placeholder="$t('hr.performance.allStatuses')" clearable size="large" style="width: 180px")
      el-option(:label="$t('performance.allStatuses')" value="")
