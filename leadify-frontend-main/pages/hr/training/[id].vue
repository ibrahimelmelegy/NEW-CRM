      ...
      .grid.gap-4(class="grid-cols-2")
        el-form-item(:label="$t('hr.training.type')")
          el-select(v-model="programForm.type" class="w-full")
            el-option(:label="$t('training.online')" value="ONLINE")
            el-option(:label="$t('training.classroom')" value="CLASSROOM")
            el-option(:label="$t('training.workshop')" value="WORKSHOP")
            el-option(:label="$t('training.certification')" value="CERTIFICATION")
            el-option(:label="$t('training.onTheJob')" value="ON_THE_JOB")
        el-form-item(:label="$t('hr.training.status')")
    ...
    el-form(label-position="top")
      ...
      el-form-item(:label="$t('hr.training.materialType')")
        el-select(v-model="materialForm.type" class="w-full")
          el-option(:label="$t('training.pdf')" value="PDF")
          el-option(:label="$t('training.video')" value="VIDEO")
          el-option(:label="$t('training.slides')" value="SLIDES")
          el-option(:label="$t('training.document')" value="DOCUMENT")
          el-option(:label="$t('training.link')" value="LINK")
    template(#footer)
