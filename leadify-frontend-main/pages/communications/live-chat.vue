        ...
        .flex.items-center.justify-between.p-4.border-b(style="border-color: var(--border-default)")
          ...
          .flex.items-center.gap-2
            ...
            el-select(
              ...
              el-option(:label="$t('liveChat.statusOpen')" value="OPEN")
              el-option(:label="$t('liveChat.statusActive')" value="ACTIVE")
              el-option(:label="$t('liveChat.statusWaiting')" value="WAITING")
              el-option(:label="$t('liveChat.statusResolved')" value="RESOLVED")
              el-option(:label="$t('liveChat.statusClosed')" value="CLOSED")
            //- Resolve button
            el-button(
    ...
    el-form(:model="createForm" label-position="top")
      ...
      el-form-item(:label="$t('liveChat.channel')")
        el-select(v-model="createForm.channel" style="width: 100%")
          el-option(:label="$t('liveChat.channelWeb')" value="WEB")
          el-option(:label="$t('liveChat.channelWhatsApp')" value="WHATSAPP")
          el-option(:label="$t('liveChat.channelFacebook')" value="FACEBOOK")
          el-option(:label="$t('liveChat.channelInstagram')" value="INSTAGRAM")
          el-option(:label="$t('liveChat.channelSMS')" value="SMS")
