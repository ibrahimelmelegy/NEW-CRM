      ...
      <div class="hidden md:flex flex-1 flex-col items-start space-y-8 animate-fade-in-left">
        ...
        <div class="space-y-4">
          <h2 class="text-4xl lg:text-5xl font-bold leading-tight text-white line-clamp-2">
            Secure your <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-gradient-end">Account</span>
          </h2>
          <p class="text-text-secondary text-lg max-w-md leading-relaxed">
            Create a strong New password to ensure your account remains protected.
          </p>
        </div>
      </div>
        ...
        <div class="glass-card p-8 md:p-12 rounded-[32px] border border-white/10 glass-card/[0.03] backdrop-blur-[20px] shadow-2xl relative overflow-hidden group">
          ...
          <div class="relative z-10">
            ...
            <div v-else class="text-center py-6 animate-fade-in">
              <div class="w-20 h-20 bg-danger/20 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg shadow-danger/10 border border-danger/30">
