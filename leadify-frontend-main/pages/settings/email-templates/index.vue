      ...
      .grid.grid-cols-2.gap-4
        ...
        el-form-item(:label="$t('emailTemplates.category')")
          el-select(v-model="form.category" class="w-full" allow-create filterable)
            el-option(:label="$t('emailTemplates.sales')" value="Sales")
            el-option(:label="$t('emailTemplates.followUp')" value="Follow-up")
            el-option(:label="$t('emailTemplates.onboarding')" value="Onboarding")
            el-option(:label="$t('emailTemplates.invoice')" value="Invoice")
            el-option(:label="$t('emailTemplates.support')" value="Support")
            el-option(:label="$t('emailTemplates.marketing')" value="Marketing")
            el-option(:label="$t('emailTemplates.general')" value="General")
