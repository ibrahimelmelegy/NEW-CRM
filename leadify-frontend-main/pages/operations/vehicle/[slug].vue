...
el-tabs.demo-tabs(v-model="activeName" @tab-click="handleClick")
  ...
  el-tab-pane(:label="$t('common.timeline')" name="timeline")
    RecordTimeline(:entityType="'vehicle'" :entityId="route.params.slug as string")
  el-tab-pane(:label="$t('common.comments')" name="comments")
    RecordComments(:entityType="'vehicle'" :entityId="route.params.slug as string")
  el-tab-pane(:label="$t('common.attachments')" name="record-attachments")
    RecordAttachments(:entityType="'vehicle'" :entityId="route.params.slug as string")
</template>
