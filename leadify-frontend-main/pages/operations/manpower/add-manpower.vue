<template lang="pug">
OperationsManPowerForm( :loading="loading" @submit="submitForm")
  .flex.items-center.justify-between.mb-8
    .title.font-bold.text-2xl.mb-1.capitalize {{ $t('operations.manpower.new') }}
...
const { t } = useI18n();
useHead({
  title: computed(() => `App HP Tech | ${t('operations.manpower.new')}`)
});
definePageMeta({
