...
.p-6.animate-entrance
  ...
  .glass-card.p-4(class="!rounded-3xl")
    AppTable(v-slot="{data}" :columns="table.columns" :filterOptions="filterOptions" position="manpower" :pageInfo="response.pagination" :data="table.data" :sortOptions="table.sort" @handleRowClick="handleRowClick" :searchPlaceholder="$t('navigation.manpower')" class="premium-table")
