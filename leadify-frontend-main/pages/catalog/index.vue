      ...
      .grid.grid-cols-2.gap-4
        ...
        el-form-item(:label="$t('catalog.category')")
          el-select(v-model="form.category" class="w-full" allow-create filterable)
            el-option(:label="$t('catalog.electronics')" value="Electronics")
            el-option(:label="$t('catalog.software')" value="Software")
            el-option(:label="$t('catalog.services')" value="Services")
            el-option(:label="$t('catalog.hardware')" value="Hardware")
            el-option(:label="$t('catalog.accessories')" value="Accessories")
      .grid.grid-cols-2.gap-4
