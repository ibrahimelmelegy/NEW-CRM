      ...
      .grid.gap-4(class="grid-cols-2")
        ...
        el-form-item(:label="$t('warehouse.status')")
          el-select(v-model="warehouseForm.status" style="width: 100%")
            ...
            el-option(:label="$t('warehouse.maintenance')" value="MAINTENANCE")
    template(#footer)
      ...
      .grid.gap-4(class="grid-cols-2")
        el-form-item(:label="$t('warehouse.zoneType')")
          el-select(v-model="zoneForm.type" style="width: 100%")
            el-option(:label="$t('warehouse.storage')" value="STORAGE")
            el-option(:label="$t('warehouse.picking')" value="PICKING")
            el-option(:label="$t('warehouse.receiving')" value="RECEIVING")
            el-option(:label="$t('warehouse.shippingZone')" value="SHIPPING")
            el-option(:label="$t('warehouse.quarantine')" value="QUARANTINE")
        el-form-item(:label="$t('warehouse.capacity')")
