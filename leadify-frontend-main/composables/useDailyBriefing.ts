  ...
  async function fetchBriefing() {
    ...
    try {
      ...
      if (activityRes.success && activityRes.body) {
        const activities = Array.isArray(activityRes.body) ? activityRes.body : (activityRes.body as unknown)?.rows || [];
      ...
      // --- Generate KPIs ---
      const insightsData: unknown = insightsRes.success ? insightsRes.body : null;
