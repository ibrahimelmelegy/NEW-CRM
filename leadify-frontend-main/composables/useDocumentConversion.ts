...
const refPrefixes: Record<string, string> = {
    proposal: 'PRP', contract: 'CTR', invoice: 'INV', proforma_invoice: 'PI',
    purchase_order: 'PO', credit_note: 'CN', quote: 'QT', rfq: 'RFQ',
    sales_order: 'SO', delivery_note: 'DN', sla: 'SLA',
};

// ── Default Titles ─────────────────────────────────────
const defaultTitles: Record<string, string> = {
    proposal: 'Project Proposal', contract: 'Service Agreement', invoice: 'Invoice',
    proforma_invoice: 'Proforma Invoice', purchase_order: 'Purchase Order',
    credit_note: 'Credit Note', quote: 'Quotation', rfq: 'Request for Quotation',
    sales_order: 'Sales Order', delivery_note: 'Delivery Note', sla: 'Service Level Agreement',
};
