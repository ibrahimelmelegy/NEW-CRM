...
export const BUILTIN_TEMPLATES: DocumentTemplate[] = [
  // ── Invoice: Classic ─────────────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('ci13', 'table', 15, 90, 180, 80, { columns: ['Item', 'Qty', 'Price', 'Total'], columnWidths: [80, 30, 35, 35], headerBg: '#1a365d', headerColor: '#ffffff', borderColor: '#e2e8f0', fontSize: 9 }),
  ...
  // ── Invoice: Modern ──────────────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('mi13', 'table', 80, 82, 115, 80, { columns: ['Item', 'Qty', 'Price', 'Total'], columnWidths: [50, 20, 22, 23], headerBg: '#6c63ff', headerColor: '#ffffff', borderColor: '#e8e6ff', fontSize: 8 }),
  ...
  // ── Invoice: Minimal ─────────────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('ni10', 'table', 15, 74, 180, 80, { columns: ['Description', 'Qty', 'Rate', 'Amount'], columnWidths: [80, 30, 35, 35], headerBg: '#f5f5f5', headerColor: '#333333', borderColor: '#e0e0e0', fontSize: 9 }),
  ...
  // ── Purchase Order: Classic ──────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('pc14', 'table', 15, 90, 180, 80, { columns: ['Item', 'Qty', 'Price', 'Total'], columnWidths: [80, 30, 35, 35], headerBg: '#065f46', headerColor: '#ffffff', borderColor: '#d1fae5', fontSize: 9 }),
  ...
  // ── Purchase Order: Modern ───────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('pm15', 'table', 15, 88, 180, 80, { columns: ['Item', 'Qty', 'Unit Price', 'Total'], columnWidths: [80, 30, 35, 35], headerBg: '#e67e22', headerColor: '#ffffff', borderColor: '#fde8cd', fontSize: 9 }),
  ...
  // ── Purchase Order: Minimal ──────────────────────────────────────────
  {
    ...
    layout: _baseLayout([
      ...
      _el('pn11', 'table', 15, 80, 180, 80, { columns: ['Description', 'Qty', 'Rate', 'Amount'], columnWidths: [80, 30, 35, 35], headerBg: '#f5f5f5', headerColor: '#333333', borderColor: '#e0e0e0', fontSize: 9 }),
