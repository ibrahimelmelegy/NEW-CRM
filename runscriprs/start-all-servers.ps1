...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'e:\NEW-CRM\leadify-backend-main'; npm run dev"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'e:\NEW-CRM\leadify-frontend-main'; npm run dev"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'e:\NEW-CRM\React proposal'; npm run dev"
