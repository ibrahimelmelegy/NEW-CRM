...
class PlannerService {
  ...
  async createTask(data: Record<string, unknown>, userId: number) {
    return Task.create({
      title: data.title,
  ...
  async updateTask(id: number, data: Record<string, unknown>, userId: number) {
  ...
  async startFocus(data: Record<string, unknown>, userId: number) {
  ...
  async createHabit(data: Record<string, unknown>, userId: number) {
