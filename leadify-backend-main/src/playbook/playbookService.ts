...
class PlaybookService {
  ...
  private async seedDefaults(tenantId?: string): Promise<void> {
    ...
    await Playbook.create({
      ...
      stages: [
        {
          id: uuidv4(), name: 'Prospecting', description: 'Identify and research potential customers', order: 1,
          steps: [
            { id: uuidv4(), title: 'Research company background', description: 'Use LinkedIn, company website, and news to understand the prospect', estimatedMinutes: 20 },
        ...
        {
          id: uuidv4(), name: 'Qualification', description: 'Determine if the prospect is a good fit', order: 2,
          steps: [
            { id: uuidv4(), title: 'Conduct discovery call', description: 'Ask BANT questions (Budget, Authority, Need, Timeline)', estimatedMinutes: 30 },
        ...
        {
          id: uuidv4(), name: 'Proposal', description: 'Present your solution and value proposition', order: 3,
          steps: [
        ...
        {
          id: uuidv4(), name: 'Negotiation', description: 'Work through terms and pricing', order: 4,
          steps: [
        ...
        {
          id: uuidv4(), name: 'Closing', description: 'Finalize the deal and onboard', order: 5,
          steps: [
