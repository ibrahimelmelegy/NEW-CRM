...
class CacheService {
   ...
   */
  async cacheDropdownOptions(key: string, options: unknown[], ttl: number = 1800): Promise<void> {
   ...
   */
  async cacheListResult(entity: string, queryHash: string, data: unknown, ttl: number = 60): Promise<void> {
