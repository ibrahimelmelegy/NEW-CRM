        ...
        try {
            const completion = await client.chat.completions.create({
                messages: [
                    {
                        role: 'system',
                        content: 'You are a professional email writing assistant for a CRM platform. Generate polished, effective business emails. Always respond with valid JSON containing "subject" and "body" fields.',
                    },
        ...
        try {
            const completion = await client.chat.completions.create({
                messages: [
                    {
                        role: 'system',
                        content: 'You are a professional email editor. Improve the given email draft based on the user\'s instruction. Respond with valid JSON containing "subject" and "body" fields. If the original has a subject line, improve it too.',
                    },
                    {
                        role: 'user',
