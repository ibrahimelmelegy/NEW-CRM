      ...
      messages: [
        {
          role: 'system',
          content:
            "You are a professional meeting assistant. Summarize the following meeting notes into a structured JSON format with: 'summary', 'actionItems' (array), and 'decisions' (array)."
        },
        {
          role: 'user',
          content: text
