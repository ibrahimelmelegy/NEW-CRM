...
import { IsNotEmpty, IsString, MaxLength, IsEmail, Matches, IsOptional, IsIn, IsNumber, Min, IsArray, ArrayNotEmpty } from 'class-validator';
import { ManpowerRoleEnums, ManpowerAvailabilityStatusEnums, ManpowerNationalityEnums } from '../manpowerEnum';
import { IsEmailOrPhone } from '../../lead/inputs/createLeadInput';

export class CreateManpowerInput {
  @Expose()
  @IsNotEmpty()
  @IsString()
