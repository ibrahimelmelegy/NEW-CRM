...
class UserService {
   ...
   */
  public async createUser(data: unknown): Promise<User> {
   ...
   */
  public async getUsers(query: unknown): Promise<unknown> {
  ...
  public async sendUsersExcelByEmail(query: unknown, email: string): Promise<void> {
