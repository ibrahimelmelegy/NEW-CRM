...
class NotificationService {
  ...
  async updateNotificationsToRead(user: User): Promise<void> {
  ...
  async sendAssignLeadNotification(input: Record<string, unknown>): Promise<void> {
  ...
  async sendProposalAssignUsersNotification(proposal: Proposal, users: number[]): Promise<void> {
  ...
  async sendApproveProposalNotification(proposal: Proposal): Promise<void> {
  ...
  async sendRejectProposalNotification(proposal: Proposal): Promise<void> {
    for (const user of proposal.users) {
      await Notification.create({
        userId: user.id,
        target: proposal.id,
  ...
  async sendAssignDealNotification(input: Record<string, unknown>, deal: Deal, admin: User): Promise<void> {
  ...
  async sendAssignProjectNotification(input: Record<string, unknown>, project: Project, admin: User): Promise<void> {
  ...
  async sendAssignClientNotification(input: Record<string, unknown>, client: Client, admin: User): Promise<void> {
  ...
  async createNotification(userId: number, title: string, body: string, metadata: Record<string, unknown> = {}): Promise<void> {
