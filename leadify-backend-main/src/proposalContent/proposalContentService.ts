...
class ProposalService {
  public async createProposalContent(data: unknown, user: User): Promise<ProposalContent> {
  ...
  public async updateProposalContent(id: string, data: unknown, user: User): Promise<ProposalContent> {
